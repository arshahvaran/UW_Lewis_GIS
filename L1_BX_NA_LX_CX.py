...
# cd C:\Users\PHYS3009\Desktop\Plastics_NetCDF\L1
# Run the code
# python L1_BX_NA_LX_CX.py
...
raster_dir = r"C:\Users\PHYS3009\Desktop\Plastics_NetCDF\L1\L1_BX_NA"
output_dir = r"C:\Users\PHYS3009\Desktop\Plastics_NetCDF\L1\L1_BX_NA_LX_CX"
...
for shp in shapefiles:
    ...
    for raster in arcpy.ListRasters():
        ...
        output_name = f"L1_{raster.split('_')[1]}_NA_L{lake}_{country_code}.tif"
