...
output_dir = r"C:\Users\PHYS3009\Desktop\Plastics_NetCDF\L3\L3_BX_NA"
...
for bin_num in range(1, 7):
    ...
    for file in os.listdir(dir_path):
        if file.endswith(".tif") and file.startswith(f"layer3_bin{bin_num}_nvars"):
    ...
    output_name = f"L3_B{bin_num}_NA.tif"
