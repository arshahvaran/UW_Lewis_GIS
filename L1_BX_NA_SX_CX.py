...
output_dir = r"C:\Users\PHYS3009\Desktop\Plastics_NetCDF\L1\L1_BX_NA_SX_Cx"
...
for shp in shapefiles:
    ...
    for raster in arcpy.ListRasters():
        ...
        output_name = f"L1_{raster.split('_')[1]}_NA_S{basin}_C{country}.tif"
